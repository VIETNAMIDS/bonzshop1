...
import { Trash2, Users, Shield, User, ShieldPlus, ShieldMinus, Loader2, Crown, Ban, CheckCircle, Globe, Monitor, Wifi, Calendar, Search } from 'lucide-react';
        ...
        {loading ? (
          ...
          <div className="space-y-3 sm:space-y-0 sm:rounded-xl sm:border sm:border-border sm:overflow-hidden">
            ...
            <div className="hidden sm:block overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-border">
                  {filteredUsers.map((u) => (
                    <tr key={u.user_id} className={`hover:bg-muted/30 transition-colors ${u.isBanned ? 'opacity-60 bg-destructive/5' : ''}`}>
            ...
            <div className="sm:hidden space-y-3">
              {filteredUsers.map((u) => (
                <div key={u.user_id} className={`glass rounded-xl p-4 ${u.isRootAdmin ? 'border border-orange-500/50' : ''} ${u.isBanned ? 'opacity-60 border-destructive/50' : ''}`}>
